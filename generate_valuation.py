...
DOW_30 = [ "AAPL", "ABBV", "ADBE", "AMD", "AMZN", "BABA", "BAC", "BA", "COST", "CSCO", "CVX", "DIS", "ETSY", "FDX", "GE", "GOOGL", "HOOD", "INTC", "JNJ", "JPM", "KO", "META", "MSFT", "NFLX", "NKE", "NVDA", "PFE", "PLTR", "PYPL", "RBLX", "SBUX", "SHOP", "SNAP", "SOFI", "SQ", "T", "TGT", "TSLA", "TSM", "UBER", "UNH", "V", "VZ", "WMT" ]
# regular list
#[
